...
```{r echo=FALSE, message=FALSE, warning=FALSE}
# Plotting histogam
ggplot(data=whiteWine, aes(whiteWine$quality)) +
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
whiteWine$quality.level <- cut(whiteWine$quality, breaks = c(0,5,6,9), labels = c( "Bad", "Average", "Good"))
table(whiteWine$quality.level)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
p1 <- ggplot(data=whiteWine, aes(x=fixed.acidity)) + geom_histogram(aes(fill=..count..), binwidth = 0.2) +
...
As seen Fixed Acidity values are mostly fall between 6 and 7.3. 


```{r echo=FALSE, message=FALSE, warning=FALSE}
p1 <- ggplot(data=whiteWine, aes(x=volatile.acidity)) + geom_histogram(aes(fill=..count..), binwidth = 0.1) +
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
p1 <- ggplot(data=whiteWine, aes(x=citric.acid)) + geom_histogram(aes(fill=..count..), binwidth = 0.01) +
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
p1 <- ggplot(data=whiteWine, aes(x=residual.sugar)) +
  geom_histogram() + 
  scale_x_log10() +
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
p1 <- ggplot(data=whiteWine, aes(x=pH)) +
  geom_histogram(aes(fill=..count..), binwidth = 0.01) +
  labs(title = "pH Histogram (Log 10)")
grid.arrange(p1)
```
...
p1 <- ggplot(aes(x = quality.level, y = fixed.acidity), data = subset(whiteWine, volatile.acidity <= quantile(volatile.acidity, 0.90))) +
  geom_boxplot(aes(group = quality.level, color = quality.level)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
p2 <- ggplot(aes(x = quality.level, y = volatile.acidity), data = subset(whiteWine, volatile.acidity <= quantile(volatile.acidity, 0.90))) +
  geom_boxplot(aes(group = quality.level, color = quality.level)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
p3 <- ggplot(aes(x = quality.level, y = citric.acid), data = subset(whiteWine, volatile.acidity <= quantile(volatile.acidity, 0.90))) +
  geom_boxplot(aes(group = quality.level, color = quality.level)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
p4 <- ggplot(aes(x = quality.level, y = pH), data = subset(whiteWine, volatile.acidity <= quantile(volatile.acidity, 0.90))) +
  geom_boxplot(aes(group = quality.level, color = quality.level)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(aes(x = quality.level, y = alcohol), data = subset(whiteWine, alcohol <= quantile(alcohol, 0.90))) +
  geom_boxplot(aes(group = quality.level, color = quality.level)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(aes(x = quality.level, y = density), data = subset(whiteWine, density <= quantile(density, 0.90))) +
  geom_boxplot(aes(group = quality.level, color = quality.level)) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
with(subset(whiteWine, density <= quantile(density, 0.99)), cor.test(quality, density))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(aes(x = residual.sugar, y = density), data = subset(whiteWine, residual.sugar <= quantile(residual.sugar, 0.99))) +
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(aes(x = total.sulfur.dioxide, y = free.sulfur.dioxide), data = subset(whiteWine, free.sulfur.dioxide <= quantile(total.sulfur.dioxide, 0.90))) +
          geom_point(aes(group = quality.level, color = quality.level)) +    
          geom_smooth() 
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(aes(x = quality.level, y = alcohol), data = subset(whiteWine, alcohol <= quantile(alcohol, 0.80))) +
...
p1 <- ggplot(aes(x = residual.sugar, y = density), data = subset(whiteWine, residual.sugar <= quantile(residual.sugar, 0.99))) +
          geom_point(aes(color = alcohol)) +    
          geom_smooth() +
          theme(axis.text.x = element_text(angle = 0)) +
          xlab("Residual Sugar (g / cm^3)") +
          ylab("Density (g / cm^3)") + 
          theme(plot.title=element_text(size=24, vjust=0), axis.title=element_text(size=18)) +
          labs(title = "Relation of Density and Residual Sugar in Alcohol Percantage & Quality Level ", color = "Alcohol %")  
p2 <- ggplot(aes(x = residual.sugar, y = density), data = subset(whiteWine, residual.sugar <= quantile(residual.sugar, 0.99))) +
  geom_point() +  
  geom_smooth() +
  xlab("Residual Sugar (g / cm^3)") +
  ylab("Density (g / cm^3)") + 
  theme(plot.title=element_text(size=24, vjust=0), axis.title=element_text(size=18), strip.text = element_text(size=18)) +
